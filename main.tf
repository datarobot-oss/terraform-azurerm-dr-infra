...
module "private_link_service" {
  ...
  pl_visibility_subscription_ids              = var.ingress_pl_visibility_subscription_ids
  pl_auto_approval_subscription_ids           = var.ingress_pl_auto_approval_subscription_ids
