...
| <a name="input_observability_grafana_admin_principal_id"></a> [observability\_grafana\_admin\_principal\_id](#input\_observability\_grafana\_admin\_principal\_id) | The principal ID for Grafana admin access in the observability module. | `string` | `null` | no |
